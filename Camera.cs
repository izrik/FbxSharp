...
namespace FbxSharp
{
    public class Camera : NodeAttribute
    {
        ...
        public PropertyT<double>                       MotionBlurIntensity         = new PropertyT<double>                     ("MotionBlurIntensity");
        ...
        public PropertyT<bool>                         AutoComputeClipPlanes       = new PropertyT<bool>                       ("AutoComputeClipPlanes");
        ...
        public PropertyT<EApertureFormat>              FilmFormat                  = new PropertyT<EApertureFormat>            ("FilmFormat");
        ...
        public PropertyT<FbxObject>                    BackgroundTexture           = new PropertyT<FbxObject>                  ("BackgroundTexture");
        ...
        public PropertyT<FbxObject>                    ForegroundTexture           = new PropertyT<FbxObject>                  ("ForegroundTexture");
        public PropertyT<double>                       ForegroundOpacity           = new PropertyT<double>                     ("ForegroundOpacity");
        ...
        public PropertyT<double>                       _2DMagnifierZoom            = new PropertyT<double>                     ("_2DMagnifierZoom");
        public PropertyT<double>                       _2DMagnifierX               = new PropertyT<double>                     ("_2DMagnifierX");
        public PropertyT<double>                       _2DMagnifierY               = new PropertyT<double>                     ("_2DMagnifierY");
        public PropertyT<EProjectionType>              ProjectionType              = new PropertyT<EProjectionType>            ("ProjectionType");
