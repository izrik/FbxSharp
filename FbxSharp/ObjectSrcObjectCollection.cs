...
namespace FbxSharp
{
    public class ObjectSrcObjectCollection : IList<FbxObject>
    {
        // An ordered collection of FbxObject source objects

        public ObjectSrcObjectCollection(FbxObject container)
        {
        ...
        {
            return string.Format("[ObjectSrcObjectCollection: Count={0}]", Count);
        }
        ...
        public List<FbxObject>.Enumerator GetEnumerator()
        {
            return _list.GetEnumerator();
        }

        IEnumerator<FbxObject> IEnumerable<FbxObject>.GetEnumerator()
        {
